...
def fetch(url):
        ...
        print(str_content)
        try:
                file = open('/Users/kshen4/code/sportdataanalysis2/standing.xml',"w")
...
def pythonXmlToJson(url):
    ...
    """
    doc_name_xml = '/Users/kshen4/code/sportdataanalysis2/standing.xml'
    doc_name_json = '/Users/kshen4/code/sportdataanalysis2/standing.json'
...
if __name__ == "__main__":
        fetch("http://api.sportsdatallc.org/soccer-t2/wc/teams/standing.xml?api_key=3jq2sehnbpnthqtgpkknsekt")
        pythonXmlToJson("http://api.sportsdatallc.org/soccer-t2/wc/teams/standing.xml?api_key=3jq2sehnbpnthqtgpkknsekt")
