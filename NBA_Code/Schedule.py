...
def fetch(url):
        ...
        print(str_content)
        try:
                file = open('/Users/kshen4/code/sportdataanalysis/NBA_Data/Regular/Schedule/Schedule.xml',"w")
...
def pythonXmlToJson(url):
    ...
    """
    doc_name_xml = '/Users/kshen4/code/sportdataanalysis/NBA_Data/Regular/Schedule/Schedule.xml'
    doc_name_json = '/Users/kshen4/code/sportdataanalysis/NBA_Data/Regular/Schedule_json/Schedule.json'
...
if __name__ == "__main__":
        fetch("http://api.sportsdatallc.org/nba-t3/games/2013/reg/schedule.xml?api_key=wrj2vd8eacveurg5kq7n4pfw")
        pythonXmlToJson("http://api.sportsdatallc.org/soccer-t2/wc/teams/standing.xml?api_key=wrj2vd8eacveurg5kq7n4pfw")
