...
def fetch(url):
        ...
        print(str_content)
        try:
                file = open('/Users/kshen4/code/sportdataanalysis/NBA_Data/Regular/Series_Schedule/Series_Schedule.xml',"w")
...
def pythonXmlToJson(url):
    ...
    """
    doc_name_xml = '/Users/kshen4/code/sportdataanalysis/NBA_Data/Regular/Series_Schedule/Series_Schedule.xml'
    doc_name_json = '/Users/kshen4/code/sportdataanalysis/NBA_Data/Regular/Series_Schedule_json/Series_Schedule.json'
...
if __name__ == "__main__":
        fetch("http://api.sportsdatallc.org/nba-t3/series/2013/pst/schedule.xml?api_key=wrj2vd8eacveurg5kq7n4pfw")
        pythonXmlToJson("http://api.sportsdatallc.org/nba-t3/series/2013/pst/schedule.xml?api_key=wrj2vd8eacveurg5kq7n4pfw")
